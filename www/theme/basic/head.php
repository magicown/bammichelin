...
<div id="hd">
    ...
    <div id="hd_wrapper">
        ...
        <div id="logo" style="z-index:999; position: absolute;">
            <a href="<?php echo G5_URL ?>"><img src="<?php echo G5_IMG_URL ?>/logo_new.png" alt="<?php echo $config['cf_title']; ?>" style="width:50%;"></a>
        </div>
